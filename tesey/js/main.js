...
(function ($) {
	...
	$(document).ready(function() {
		$('.sm_menu_outer ul li a').on("click", function () {
	...
	$(".menu--tesey-menu li").last().find('a').addClass('appao-btn');
	$(".menu--tesey-menu .appao-btn").css('pointer-events', 'none');
	$("#block-contactblock-2").before('<span class="btn_close_"></span>');
	

	
	$(".menu--tesey-menu li").last().on("click", function () {
		$("#block-contactblock-2").addClass('dialog');
		$(".btn_close_").show();
	});
	
	$(".btn_close_").on("click", function () {
		$("#block-contactblock-2").removeClass('dialog');
		$(".btn_close_").hide();
	});

	$(".appao-btn").on("click", function () {
		$("#block-contactblock-2").addClass('dialog');
		$(".btn_close_").show();
	});
